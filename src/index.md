...
title: Toruk
titleTemplate: Uncomplicate API

hero:
  name: Toruk
  text: Uncomplicate API
  tagline: Build APIs fast, maintain them with ease
  actions:
    - theme: brand
      text: Quick Start
      link: /guide
    - theme: alt
      text: Why Toruk?
      link: /guide/why-toruk

features:
  - icon: ⚡
    title: Fast & Intuitive
    details: Built following Deno standards.
  ...
  - icon: 🔋
    ...
    details: Built-in middlewares.
  - icon: 🎉
    title: Delightful DX
    details: Flexible and well known API.
---

<style>
:root {
  --vp-home-hero-name-color: transparent;
  --vp-home-hero-name-background: linear-gradient(120deg,  #f6763f 10%, #faef7a);
}
</style>
